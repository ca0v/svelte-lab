...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  audio = {
     ...
     * @tags Audio
     * @name ListList
     * @request GET:/Audio/list
     */
    listList: (params: RequestParams = {}) =>
      this.request<Recording[], any>({
        path: `/Audio/list`,
        method: "GET",
        format: "json",
        ...params,
