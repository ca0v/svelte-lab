const hexagons =
    [{
        ...
        transforms: [
            ...
            {
                i: 1,
                style: "transform: rotate(0deg) translate(40px, 0) rotate(0deg)",
            },
            {
                i: 2,
                style: "transform: rotate(60deg) translate(40px, 0) rotate(-60deg)",
            },
            {
                i: 3,
                style: "transform: rotate(120deg) translate(40px, 0) rotate(-120deg)",
            },
            {
                i: 4,
                style: "transform: rotate(180deg) translate(40px, 0) rotate(-180deg)",
            },
            {
                i: 5,
                style: "transform: rotate(240deg) translate(40px, 0) rotate(-240deg)",
            },
            {
                i: 6,
                style: "transform: rotate(300deg) translate(40px, 0) rotate(-300deg)",
            },
            {
                i: 7,
                style: "transform: rotate(0deg) translate(80px, 0) rotate(-0deg) ",
            },
            {
                i: 8,
                style: "transform: rotate(60deg) translate(80px, 0) rotate(-60deg) ",
            },
            {
                i: 9,
                style: "transform: rotate(120deg) translate(80px, 0) rotate(-120deg) ",
            },
            {
                i: 10,
                style: "transform: rotate(180deg) translate(80px, 0) rotate(-180deg) ",
            },
            {
                i: 11,
                style: "transform: rotate(240deg) translate(80px, 0) rotate(-240deg) ",
            },
            {
                i: 12,
                style: "transform: rotate(300deg) translate(80px, 0) rotate(-300deg) ",
            },
            {
                i: 13,
                style: "transform: rotate(30deg) translate(69.5px, 0) rotate(-30deg)",
            },
            {
                i: 14,
                style: "transform: rotate(90deg) translate(69.5px, 0) rotate(-90deg)",
            },
            {
                i: 15,
                style: "transform: rotate(150deg) translate(69.5px, 0) rotate(-150deg)",
            },
            {
                i: 16,
                style: "transform: rotate(210deg) translate(69.5px, 0) rotate(-210deg)",
            },
            {
                i: 17,
                style: "transform: rotate(270deg) translate(69.5px, 0) rotate(-270deg)",
            },
            {
                i: 18,
                style: "transform: rotate(330deg) translate(69.5px, 0) rotate(-330deg)",
            },
        ],
        "positions": [
